    ...
    <div class="min-h-screen bg-slate-50/50 py-12">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-black text-slate-800 tracking-tight">Tambah Produk</h2>
                    <p class="text-sm text-slate-500">Input data inventaris baru ke sistem SCM.</p>
                </div>
            ...
            <div class="bg-white rounded-[2rem] shadow-xl shadow-slate-200/60 border border-white overflow-hidden">
                <form action="{{ route('products.store') }}" method="POST" class="p-8 sm:p-12">
                    @csrf
                    ...
                    <div class="space-y-10">
                        <section>
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="name" placeholder="Misal: Laptop Victus 15" 
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="text" name="sku" placeholder="LOG-PRD-001" 
                                            class="w-full px-5 py-4 rounded-2xl border-slate-100 bg-slate-50 focus:bg-white focus:border-slate-900 focus:ring-0 transition-all placeholder:text-slate-300 shadow-sm" required>
                                    </div>
                                    <div>
                        ...
                        <section>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label class="block text-xs font-black text-slate-400 uppercase tracking-wider mb-2 ml-1">Stok Awal</label>
